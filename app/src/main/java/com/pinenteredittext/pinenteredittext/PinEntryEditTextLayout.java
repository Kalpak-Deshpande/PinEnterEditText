package com.pinenteredittext.pinenteredittext;
...
public class PinEntryEditTextLayout extends AppCompatEditText {
    ...
    public PinEntryEditTextLayout(Context context) {
        super(context);
    }

    public PinEntryEditTextLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PinEntryEditTextLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.PinEntryEditTextLayout, 0, 0);
        try {
            TypedValue outValue = new TypedValue();
            ta.getValue(R.styleable.PinEntryEditTextLayout_pinAnimationType, outValue);
            mAnimatedType = outValue.data;
            mMask = ta.getString(R.styleable.PinEntryEditTextLayout_pinCharacterMask);
            mSingleCharHint = ta.getString(R.styleable.PinEntryEditTextLayout_pinRepeatedHint);
            mLineStroke = ta.getDimension(R.styleable.PinEntryEditTextLayout_pinLineStroke, mLineStroke);
            mLineStrokeSelected = ta.getDimension(R.styleable.PinEntryEditTextLayout_pinLineStrokeSelected, mLineStrokeSelected);
            mSpace = ta.getDimension(R.styleable.PinEntryEditTextLayout_pinCharacterSpacing, mSpace);
            mTextBottomPadding = ta.getDimension(R.styleable.PinEntryEditTextLayout_pinTextBottomPadding, mTextBottomPadding);
            mIsDigitSquare = ta.getBoolean(R.styleable.PinEntryEditTextLayout_pinBackgroundIsSquare, mIsDigitSquare);
            mPinBackground = ta.getDrawable(R.styleable.PinEntryEditTextLayout_pinBackgroundDrawable);
            ColorStateList colors = ta.getColorStateList(R.styleable.PinEntryEditTextLayout_pinLineColors);
            if (colors != null) {
                mColorStates = colors;
            }
        } finally {
    ...
    private void animatePopIn() {
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                PinEntryEditTextLayout.this.invalidate();
            }
        });
